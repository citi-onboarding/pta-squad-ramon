...
export default function TelaAtendimento() {
  return (
    <div className="h-screen w-screen">
      <Header />
      <div className="flex flex-col pt-[48px] border border-purple-800">
      <div className="pl-[256px]">
        ...
        <Tabs defaultValue="agendamento" className="w-[400px] mt-[40px]">
          <TabsList className="w-[243px] h-[58px] p-2 pb-8">
            <div className="w-[124px] h-[42px]">
              <TabsTrigger value="agendamento" className="text-base font-normal rounded-lg pl-[16px] pr-[16px] pt-[12px] pb-[12px]">Agendamento</TabsTrigger>
            </div>
            <div className="w-[124px] h-[42px]">
              <TabsTrigger value="historico" className="text-base font-normal rounded-lg pl-[16px] pr-[16px] pt-[12px] pb-[12px]">Histórico</TabsTrigger>
            </div>
          </TabsList>
          <TabsContent value="agendamento" className="w-[1532px] h-[294px]">
          ...
          <TabsContent value="historico" className="w-[1532px] h-[294px]">
            <div className="grid grid-cols-3 grid-rows-2 gap-6 ">
              <CardConsultaPet 
                dataHora="18/02 13:00"
                nomePet="Luna"
